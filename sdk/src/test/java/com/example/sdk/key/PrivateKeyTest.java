...
public class PrivateKeyTest {
  ...
  public void shouldGeneratePrivateKey() {
    final PrivateKey key = KeyFactory.generatePrivateKey();
...
//  }
  ...
  public void roundTripGeneratingAndCreatingPrivateKey() {
    final PrivateKey privateKey = KeyFactory.generatePrivateKey();
    final String hexKey = Hex.toHexString(privateKey.getBytes());
